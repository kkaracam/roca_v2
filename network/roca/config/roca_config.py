...
def roca_config(
    ...
    cfg.JOINT_SRC_DIR = '/mnt/noraid/karacam/ThesisData/joint_learning_retrieval_deformation/data/roca_sources_part_thresh_32_1024p_v1/{}/h5/'
    cfg.JOINT_SRC_PKL = cfg.JOINT_BASE_DIR+"data/generated_datasplits/{}_{}_roca.pickle"
    cfg.JOINT_MODEL_PATH = joint_model_path
    cfg.JOINT_WITH_ICP = joint_with_icp
